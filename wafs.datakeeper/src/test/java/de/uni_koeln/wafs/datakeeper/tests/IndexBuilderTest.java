...
public class IndexBuilderTest {
	...
	public void createMocks() {
		...
		track1.setLocation("https://de.wikipedia.org/wiki/London_Calling");
		...
		track2.setLocation("https://de.wikipedia.org/wiki/London_Calling");
		...
		track3.setLocation("https://de.wikipedia.org/wiki/London_Calling");
